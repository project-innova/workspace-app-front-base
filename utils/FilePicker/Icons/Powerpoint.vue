<template>
    <svg :class="$attrs.class" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g mask="url(#mask0_87_7757)">
            ...
            <path d="M6 12C6 10.3431 7.34315 9 9 9H17C18.6569 9 20 10.3431 20 12V24C20 25.6569 18.6569 27 17 27H6V12Z"
        ...
        <path
            ...
            fill="white" />
        <defs>
            <linearGradient id="paint0_linear_87_7757" x1="3" y1="17.931" x2="31" y2="17.931"
            ...
            <linearGradient id="paint2_linear_87_7757" x1="7.38325e-08" y1="17.2414" x2="18" y2="17.2414"
                gradientUnits="userSpaceOnUse">
                <stop stop-color="#A73A24" />
                <stop offset="1" stop-color="#F75936" />
            </linearGradient>
